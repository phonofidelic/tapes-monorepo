    ...
    <>
      ...
      <div
        className={clsx(
          ...
          'absolute bottom-[79px] left-0 w-full rounded-t-lg border border-zinc-100 bg-white text-zinc-400 transition-transform dark:border-zinc-800 dark:bg-zinc-900',
          {
